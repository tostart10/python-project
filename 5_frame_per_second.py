...
while running:
    dt = clock.tick(10) # 게임화면의 초당 프레임 수를 설정  /dt는 델타/()에는 원하는 프레임 수를 넣으면됨
    #현재 돌고있는 프레임을 확인할수 있는 코드
    #=>print("fps : " + str(clock.get_fps()))
    #프레임 값이 낮으면 느리고 부자연스러움
...
#프레임이 바뀐다고 해서 캐릭의 이동의 부드러움정도는 바뀔수는 있지만  게임자체의 속도가 달라지면 안됨 > 고정을해서 속도를 고정해줘야한다.
#값 고정을 위해 while문에 있는 dt(델타)값을 곱해준다
